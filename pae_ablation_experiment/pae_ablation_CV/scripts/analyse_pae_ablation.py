#!/usr/bin/env python3
"""
Analyse PAE ablation experiment results.
Compares 5-fold CV AUROC between models with and without PAE features.
"""
...
def print_summary(results):
    """Print summary table of per-fold AUROCs."""
    print("\n" + "=" * 80)
    print("PAE Ablation Experiment — 5-fold CV AUROC Summary")
    print("=" * 80)
...
def verify_splits(results):
    """Verify that all conditions used the same CV splits."""
    print("\n" + "-" * 80)
